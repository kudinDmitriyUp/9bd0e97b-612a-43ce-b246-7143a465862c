...
export const metadata: Metadata = {
  title: "Kafey - Ukrainian Coffeeshop",
  description: "Experience authentic Ukrainian coffee culture. Fresh espresso, pastries, and warm hospitality in our cozy local coffeeshop.",
  keywords: "coffee, coffeeshop, Ukrainian, espresso, cafe, local",
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: "Kafey - Ukrainian Coffeeshop",
    description: "Authentic Ukrainian coffee experience with fresh beans and warm hospitality",
    type: "website",
    siteName: "Kafey",
  },
};
